...
def get_toroidalmap_pattern_function_map():
    return {
...
def toroidal_methuselah_quadrants_pattern(
    ...
    return rectangular_methuselah_quadrant_pattern(
        rows,
        cols,
        seed=None,
        methuselah_hcounts=hmc,
        methuselah_vcounts=vmc,
        methuselah_names=methuselah_names,
    )
...
def rabbitfarm_twocolor(rows, cols, seed=None):
    ...
    team1_wabbits, team2_wabbits = toroidal_methuselah_quadrants_pattern(
